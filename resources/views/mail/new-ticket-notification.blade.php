                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;">
                        <tr>
                            <td style="padding:24px 24px 12px;">
                                ...
                                <h1 style="margin:0;color:#111827;font-size:22px;">Nowe zgloszenie {{ $ticket->number }}</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:12px 24px;">
                                <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
                                    W systemie pojawilo sie nowe zgloszenie od
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;line-height:1.6;border-collapse:collapse;">
                                    <tr>
                                        <td style="padding:6px 0;color:#6b7280;">Email klienta</td>
                                        <td style="padding:6px 0;text-align:right;font-weight:700;">{{ $ticket->requester_email }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td style="padding:12px 24px 24px;">
                                ...
                                <p style="margin:18px 0 0;color:#6b7280;font-size:12px;line-height:1.5;">
                                    Otrzymujesz te wiadomosc, poniewaz masz wlaczone powiadomienia o nowych ticketach.
                                </p>
                            </td>
                        </tr>
                    </table>

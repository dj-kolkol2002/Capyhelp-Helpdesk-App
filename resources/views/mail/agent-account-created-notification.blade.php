                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;">
                        <tr>
                            <td style="padding:24px 24px 12px;">
                                ...
                                <h1 style="margin:0;color:#111827;font-size:22px;">Utworzono Twoje konto</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:12px 24px;">
                                <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
                                    Administrator utworzyl konto dla <strong>{{ $agent->name }}</strong>.
                                </p>
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;line-height:1.6;border-collapse:collapse;">
                                    <tr>
                                        ...
                                        <td style="padding:6px 0;text-align:right;font-weight:700;">{{ $agent->email }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:6px 0;color:#6b7280;">Rola</td>
                                        <td style="padding:6px 0;text-align:right;font-weight:700;">{{ $agent->role }}</td>
                                    </tr>
                                </table>
                                <p style="margin:16px 0 0;border-left:4px solid #10b981;background:#ecfdf5;padding:12px 14px;border-radius:4px;font-size:14px;line-height:1.6;">
                                    Haslo startowe zostalo ustawione przez administratora. Jesli go nie znasz, skontaktuj sie z administratorem.
                                </p>
                            </td>
                        </tr>
                        <tr>
